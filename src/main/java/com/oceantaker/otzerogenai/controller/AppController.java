...
import com.oceantaker.otzerogenai.model.dto.app.AppAdminUpdateRequest;
import com.oceantaker.otzerogenai.model.dto.app.AppQueryRequest;
import com.oceantaker.otzerogenai.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Boolean> updateApp(@RequestBody AppUpdateRequest appUpdateRequest, HttpServletRequest request) {
        ...
        boolean result = appService.updateById(app); // MyBatis/Flex内置的更新方法
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
    ...
    public BaseResponse<Page<AppVO>> listMyAppVOByPage(@RequestBody AppQueryRequest appQueryRequest, HttpServletRequest request) {
        ...
        User loginUser = userService.getLoginUser(request); // 获取当前登录用户，相当于校验登录态
        // 限制每页最多 20 个 ，防止爬虫
        ...
        QueryWrapper queryWrapper = appService.getQueryWrapper(appQueryRequest); // service层刚写的查询转换方法
